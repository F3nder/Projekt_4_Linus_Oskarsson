...
/********************************************************************************
* tmp36_print_average_temperature: Skriver ut genomsnitts rumstemperatur avläst
*                                  av temperatursensor TMP36.
*
*                                 - average_temp: Pekare till genomsnitts temp:
********************************************************************************/
void tmp36_print_average_temperature(const uint32_t average_temp)
{
	serial_print_string("Average Temperature: ");
	serial_print_double(average_temp);
	serial_print_string(" degrees Celcius.\n");
	return;
}
